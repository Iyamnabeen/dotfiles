...
static const char *fonts[]          = { "JetBrainsMono Nerd Font, monospace:size=11"};
static const char dmenufont[]       = "JetBrainsMono Nerd Font, monospace:size=11";
...
static char selbordercolor[]        = "#fc0328";
...
/* tagging */
static const char *tags[] = { " terminal", " browser", "burpsuite", " others", " useless" };
